...
function Home() {
  ...
  return (
    <>
      ...
      <div className="text-center flex gap-5 justify-center  my-10">
            ...
            <span
              className={
                number == currentpage
                  ...
                  : " text-neutral-700   border-neutral-400 border p-3 transform scale-95 transition-all duration-500 cursor-pointer shadow-sm"
              }
